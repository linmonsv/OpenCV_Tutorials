...
int main(int argc, char** argv)
{
    ...
    Mat src_base = imread("Histogram_Comparison_Source_0.jpg");
    Mat src_test1 = imread("Histogram_Comparison_Source_1.jpg");
    Mat src_test2 = imread("Histogram_Comparison_Source_2.jpg");
